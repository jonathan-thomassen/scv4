...
static void
spawn_object(TLN_ObjectInfo const* info) {
...
static void
push_simon_on_bridge(bool db_active) {
...
static void
update_layer_positions(int scroll_x, bool db_triggered, int* p_prev_xpos) {
...
static void
tick_chain_prop(bool db_triggered, int xpos) {
...
static bool
process_pause(bool* p_paused, bool* p_esc_prev) {
...
static void
update_fps_title(Uint64* p_t0, int* p_frames) {
    (*p_frames)++;
